...
load("tt4_start_by_hour_results_with_data.Rdata")
...
load("tt4_dont_start_until_results_with_data.Rdata")
...
load("tt4_dont_start_until_results_intubation_outcome_with_data.Rdata")
